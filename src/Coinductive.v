...
このような設定においては，
無限の大きさをもつリストを作りたければ無限ループになるプログラムを書くことは簡単ですが，
そのリストの先頭の有限個の要素が必要なら
有限の時間で結果を得られるようにしておく必要があります．
Haskellプログラマはそういった誤りに気をつけながらプログラムを書く方法を学習しますが，
Coqで関数やデータを定義する際にはこのような自由放任主義が通用しません．
...
この証明手順からどのようの証明項が生成されるかを考えてみれば，
